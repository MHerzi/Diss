function [LogL,Rt,likelihood,u]=CopulaVineLL_grm(phi,data,CopulaSpec)
...
if strcmp(CopulaSpec.type,'SJC')==0
    ...
    elseif strcmp(CopulaSpec.corrspec,'GDCC') == 1 && (strcmp(CopulaSpec.type,'Gaussian') == 1 || ...
        ...
        DynamicSpec = crIPmat_grm(DynamicSpec);
    elseif strcmp(CopulaSpec.corrspec,'GDCC') && strcmp(CopulaSpec.type,'t')
        k=1;
        DynamicSpec=cell((.5*N*(N-1)),1);
        for i=1:5:size(phi,1)
            DynamicSpec{k,1} =phi(i:i+4);
            k=k+1;
        end
        DynamicSpec = crIPmat_grm(DynamicSpec);
    elseif strcmp(CopulaSpec.corrspec,'AGDCC') && strcmp(CopulaSpec.type,'t')
        k=1;
        DynamicSpec=cell((.5*N*(N-1)),1);
        for i=1:7:size(phi,1)
            DynamicSpec{k,1} =phi(i:i+6);
            k=k+1;
        end
        DynamicSpec = crIPmat_grm(DynamicSpec);
    end
...
%                         [lik(j,i), Rt{j,i}]=CopulaLL_grm(DynamicSpec{j,i},[data(:,1),data(:,i+1)],CopulaSpec);
%                     else
%                         [lik(j,i), Rt{j,i}]=CopulaLL_grm(phi(j,i),[data(:,1),data(:,i+1)],CopulaSpec);
%                     end
%                 else
%                     if strcmp(CopulaSpec.corrspec,'Patton') == 1 || strcmp(CopulaSpec.corrspec,'DCC') == 1 || strcmp(CopulaSpec.corrspec,'TVC') ==1
%                         [lik(j,i),Rt{j,i}]=CopulaLL_grm(DynamicSpec{j,i},[u{j-1,1},u{j-1,i+1}],CopulaSpec);
%                     else
%                         [lik(j,i),Rt{j,i}]=CopulaLL_grm(phi(j,i),[u{j-1,1},u{j-1,i+1}],CopulaSpec);
%                     end
%                 end
%             end
%             if j<N-1
...
%         end
    elseif strcmp(dec,'DVine')==1
        ...
        for i=1:N-1
            ...
            if strcmp(type,'t')== 0 && (strcmp(CopulaSpec.corrspec,'Patton') == 1 || strcmp(CopulaSpec.corrspec,'DCC') == 1 || strcmp(CopulaSpec.corrspec,'TVC') == 1 || strcmp(CopulaSpec.corrspec,'ADCC') == 1 ...
                ...
                if strcmp(type,'t') == 1 && strcmp(CopulaSpec.corrspec,'static') == 1
                    ...
                    countl=countl+1;
                elseif strcmp(type,'t') == 1 && strcmp(CopulaSpec.corrspec,'static') == 0
                    [lik(1,i),Rt{1,i},likelihood(:,countl)]=CopulaLL_grm(DynamicSpec{1,i},[data(:,i) data(:,i+1)],CopulaSpec);
                    countl=countl+1;
                end
            end
        ...
        if strcmp(type,'t')== 0 && (strcmp(CopulaSpec.corrspec,'Patton') == 1 || strcmp(CopulaSpec.corrspec,'DCC') == 1 || strcmp(CopulaSpec.corrspec,'TVC') == 1 || strcmp(CopulaSpec.corrspec,'ADCC') == 1 ...
            ...
            elseif strcmp(type,'t') == 1 && strcmp(CopulaSpec.corrspec,'static') == 0
                u{1,1}=hfunc_grm(data(:,1),data(:,2),DynamicSpec{1,1},CopulaSpec);
            end
        end
            ...
            for i=1:(N-j)
                if strcmp(type,'t')== 0 && (strcmp(CopulaSpec.corrspec,'Patton') == 1 || strcmp(CopulaSpec.corrspec,'DCC') == 1 || strcmp(CopulaSpec.corrspec,'TVC') == 1 || strcmp(CopulaSpec.corrspec,'ADCC') == 1 ...
                    ...
                    if strcmp(type,'t') == 1 && strcmp(CopulaSpec.corrspec,'static') == 1
                        ...
                        countl=countl+1;
                    elseif strcmp(type,'t')&& strcmp(CopulaSpec.corrspec,'static') == 0
                        [lik(j,i),Rt{j,i},likelihood(:,countl)]=CopulaLL_grm(DynamicSpec{j,i},[u{j-1,2*i-1} u{j-1,2*i}],CopulaSpec);
                        countl=countl+1;
                    end
                end
...
if strcmp(CopulaSpec.type,'SJC')
    ...
    %             for i=1:N-j
    %                 if j==1
    %                     [lik(j,i),Rt{j,i},likelihood(:,countl)]=CopulaLL_grm(phi{j,i},[data(:,1),data(:,i+1)],CopulaSpec);
    %                     countl=countl+1;
    %                 else
    %                     [lik(j,i),Rt{j,i},likelihood(:,countl)]=CopulaLL_grm(phi{j,i},[u{j-1,1},u{j-1,i+1}],CopulaSpec);
    %                     countl=countl+1;
    %                 end
    %             end
    %             if j<N-1
