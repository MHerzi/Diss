...
%     ar_skewt_avgarch(data , p , q , arlag, const, startingvals, options)
%
%
% INPUTS:
...
[parameters, LLF, EXITFLAG, OUTPUT, LAMBDA, GRAD] =  fmincon('ar_skewt_avgarchlikelihood_grm', startingvals , sumA, sumB,[],[],[],[],'ar_garch_skewt_nonlincon',options, data, p, q, m, arlag, const);
[LLF, Holder, likelihood, resid] = ar_skewt_avgarchlikelihood_grm(parameters , data , p , q, m, arlag, const);
