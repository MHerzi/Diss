function [parameters, LLF, stderrors, robustSE, ht, scores, resid, likelihood, EXITFLAG] = ar_avgarch_garch_grm(data , p , q , errors, arlag, const, startingvals, options, computeInference)
% PURPOSE:
...
likelihood = [];
if computeInference
    hess = hessian_2sided('ar_avgarch_garchlikelihood_grm', ...
        parameters, data, p, q, errortype, arlag, const);
    [~, ht, likelihood] = ar_avgarch_garchlikelihood_grm( ...
        parameters, data, p, q, errortype, arlag, const);
