...
%%% MFE-Toolbox
%[parameters_AR] = armaxfilter(data,const,arlag-1,0,[],[],optionsAR);
%AR = parameters_AR; %Modifikation am 04.04.2013, da parameters_AR als Zeilenvektor ausgegeben wird
...
[parameters, LLF, EXITFLAG, OUTPUT, LAMBDA, GRAD] =  fmincon('ar_fattailed_garchlikelihood_grm', startingvals , sumA  , sumB ,[] , [] , [] , [],'ar_fattailedgarch_nonlincon',options, data, p , q, errortype, arlag, const);
[LLF, Holder, Holder, resid] = ar_fattailed_garchlikelihood_grm(parameters , data , p , q, errortype, arlag, const);
