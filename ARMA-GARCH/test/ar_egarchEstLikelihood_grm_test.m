function [LLF, h, likelihoods]= ar_egarchEstLikelihood_grm_test(parameters,data,p,o,q,errortype,arlag)
% PURPOSE:
...
if errortype == 1
    parameters = parameters(1:q+p+o+q);
elseif errortype ==2;
    nu = 2.1 +parameters(end)^2;
    parameters = parameters(1:(1+p+o+q));
elseif errortype ==3;
    nu = 1.05 + parameters(end)^2;
    parameters = parameters(1:(1+p+o+q));
elseif errortype ==4;
    nu = parameters(end-1);
