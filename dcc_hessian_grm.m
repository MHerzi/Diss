function H = dcc_hessian_grm(f,x,N,varargin)
% PURPOSE:
...
% based on the DCC of Kevin Sheppard
% 14.August 2009
...
%   Copyright (c) Kevin Sheppard and Martin Grziska
...
h = eps.^(1/3)*ones(n,1);%max(abs(x),1);
xh = x+h;
h = xh-x;
