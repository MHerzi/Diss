...
function [LL_Mix, LL, CopParam_tv, weights_tv, density, MixDensity, PropDensity] = copulaLL_mix_tv_grm2_var(tv_faktor, CopParam_1, family, data, P, Q, Dynamic, Density_Func_in, epsilon);
...
% -----------------------------------------------------------------------
        case {'clayton','rotclayton'}
            ...
            if s2==2 % f�r zwei Zeitreihen greife auf die Originalspezifikation van Patton zur�ck
                ...
                tau = copulaParam_tv_Patton_grm2_var(family{n_Cop},tv_faktor(nf+1:nf+3),CopParam_1(n_Cop),data,'kalibrieren');
            end
