function [Output,Output_Gauss] = AR_MarginalModel_Mittnik(data,const,arlag)
...
for j=1:k
    ...
    elseif BIC_opt{j}==17
        ...
        % wird abgelehnt
        [stat_Kolmogorov_resid, siglevel_Kolmogorov_resid, H_Kolmogorov_resid]=kolmogorov(stdresid,.05,'tdis_cdf',parameters_GARCH_GED(end));
    ...
    elseif BIC_opt{j}==18
        ...
        % Verteilung (in diesem Fall der GED; 0: H0 wird nicht abgelehnt; 1: H0
        % wird abgelehnt
        [stat_Kolmogorov_resid, siglevel_Kolmogorov_resid, H_Kolmogorov_resid]=kolmogorov(stdresid,.05,'tdis_cdf',parameters_EGARCH_GED(end));
    ...
    elseif BIC_opt{j}==19
        ...
        % Verteilung (in diesem Fall der GED; 0: H0 wird nicht abgelehnt; 1: H0
        % wird abgelehnt
        [stat_Kolmogorov_resid, siglevel_Kolmogorov_resid, H_Kolmogorov_resid]=kolmogorov(stdresid,.05,'tdis_cdf',parameters_TGARCH_GED(end));
    ...
    elseif BIC_opt{j}==20
        ...
        % Verteilung (in diesem Fall der GED; 0: H0 wird nicht abgelehnt; 1: H0
        % wird abgelehnt
        [stat_Kolmogorov_resid, siglevel_Kolmogorov_resid, H_Kolmogorov_resid]=kolmogorov(stdresid,.05,'tdis_cdf',parameters_GJRGARCH_GED(end));
        ...
        Output{j}.ParamsAR = parameters_GJRARCH_GED(size(Output{j}.ParamsGARCH,1)-1+1:size(parameters_GJRGARCH_GED,1)-1);
    ...
    elseif BIC_opt{j}==21
        ...
        % Verteilung (in diesem Fall der GED; 0: H0 wird nicht abgelehnt; 1: H0
        % wird abgelehnt
        [stat_Kolmogorov_resid, siglevel_Kolmogorov_resid, H_Kolmogorov_resid]=kolmogorov(stdresid,.05,'tdis_cdf',parameters_AVGARCH_GED(end));
        U_AVGARCH_GED(i,:)=gedcdf(stdresid,parameters_AVGARCH_GED(end));
    ...
    elseif BIC_opt{j}==22
        ...
        % Verteilung (in diesem Fall der GED; 0: H0 wird nicht abgelehnt; 1: H0
        % wird abgelehnt
        [stat_Kolmogorov_resid, siglevel_Kolmogorov_resid, H_Kolmogorov_resid]=kolmogorov(stdresid,.05,'tdis_cdf',parameters_NGARCH_GED(end));
    ...
    elseif BIC_opt{j}==23
        ...
        % Verteilung (in diesem Fall der GED; 0: H0 wird nicht abgelehnt; 1: H0
        % wird abgelehnt
        [stat_Kolmogorov_resid, siglevel_Kolmogorov_resid, H_Kolmogorov_resid]=kolmogorov(stdresid,.05,'tdis_cdf',parameters_NAGARCH_GED(end));
    ...
    elseif BIC_opt{j}==24
        ...
        % Verteilung (in diesem Fall der GED; 0: H0 wird nicht abgelehnt; 1: H0
        % wird abgelehnt
        [stat_Kolmogorov_resid, siglevel_Kolmogorov_resid, H_Kolmogorov_resid]=kolmogorov(stdresid,.05,'tdis_cdf',parameters_APGARCH_GED(end));
