...
function [CopParam_tv, Weights_tv, tv_faktor, LL_Mix, LL, AIC, BIC] = copulafitmix_paper(family, data)
...
for i = 1:nc
    switch family{i}
        case {'gumbel' 'clayton'} % zeitvariabler Parameter wird entsprechend Patton (2006) kalibriert
            ...
            elseif nc > 1
                [m1, m2, ArchCopParam_tv] = copulafitmix_tv_paper(family{i}, data);
                clear m1 m2
...
[AIC, BIC] = aicbic_grm(LL_Mix, np, s1*s2);
