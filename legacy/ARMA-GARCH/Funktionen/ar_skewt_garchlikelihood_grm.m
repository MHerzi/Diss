function [LLF, h, likelihoods, resid] = ar_skewt_garchlikelihood_grm(parameters , data , p , q, m, arlag, const)
% PURPOSE:
...
T           =  size(resid,1);
h=garchcore(resid,parameters(1:1+p+q),stdEstimate,p,q,m,T);
