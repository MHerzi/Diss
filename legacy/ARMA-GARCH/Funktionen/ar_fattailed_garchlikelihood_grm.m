function [LLF, h, likelihoods, resid] = ar_fattailed_garchlikelihood_grm(parameters , data , p , q, errortype, arlag, const)
% PURPOSE:
...
h=garchcore(resid,parameters,stdEstimate,p,q,m,T);
Tau = T-m;
LLF = 0;
t = (m + 1):T;
if errortype == 1
