function [LLF, h, likelihoods]= ar_egarchEstLikelihood_grm(parameters,data,p,o,q,errortype,arlag, const)
% PURPOSE:
...
elseif errortype ==2;
    nu=parameters(end);
    parameters = parameters(1:(p+o+q+1));
elseif errortype ==3;
    nu=parameters(end);
    parameters = parameters(1:(p+o+q+1));
elseif errortype ==4;
...
% h = egarchcore_grm(resid, parameters, stdEstimate, p, o, q ,m , T, errortype);
