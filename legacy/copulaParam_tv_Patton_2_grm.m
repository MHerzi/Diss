...
% - GD: nx1 Vektor der absoluten Gesamtdistanzen geteilt durch die
% Laganzahl
%
%   Author: Valentin Braun
%   Phd Student in finance Goethe Universität
function [CopParam_tv, GD] = copulaParam_tv_Patton_2_grm(family,tv_faktor,CopParam_1,data,funktion,horizon);
...
if s2<2 || s2>14
    error('Es können minimal 2 und maximal 14 Zeitreihen in den dynamischen Copulas verwendet werden');
end
