function [LogL, StrOutput, CopulaSpec, phi]=CopulaVine_LL_multistep_mix_grm(data,CopulaSpec,StrOutput,phi);
...
if strcmp(CopulaSpec.decomposition,'DVine-Mix') == 0
    ...
    [StrOutput,phi] = Est_Vine_multistep_mix(CopulaSpec,N,data,T);
    LogL=[];
end
