...
function [V StdError p_Wert t_Wert] = copulaStat_mix_tv_grm2(Stat, MLE_Param, CopParam_1, weights_1, family, U, P, Q, Dynamic);
...
switch Stat
    ...
    case 'an'
        ...
        n = zeros(s1, np);
        [H1, H2, H3, H4, H5, density] =  copulaLL_mix_tv_grm2(MLE_Param, CopParam_1, family, U, P, Q, Dynamic);
        ...
        for i = 1:np
            ...
            [H1, H2, H3, H4, H5, density] =  copulaLL_mix_tv_grm2(delta_Param, CopParam_1,  family, U, P, Q, Dynamic);
        ...
        for i = 1:np
            for j = 1:np
                ...
                % Berechnen der LL
                [sumlik11] = copulaLL_mix_tv_grm2(delta_Param_11, CopParam_1,  family, U, P, Q, Dynamic);
                [sumlik12] = copulaLL_mix_tv_grm2(delta_Param_12, CopParam_1,  family, U, P, Q, Dynamic);
                [sumlik21] = copulaLL_mix_tv_grm2(delta_Param_21, CopParam_1,  family, U, P, Q, Dynamic);
                [sumlik22] = copulaLL_mix_tv_grm2(delta_Param_22, CopParam_1,  family, U, P, Q, Dynamic);
