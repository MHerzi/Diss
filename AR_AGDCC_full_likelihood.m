function [logL, Rt, likelihoods, Qt] = AR_AGDCC_full_likelihood(parameters, data, archP, garchQ, o, garchtype, errortype, dccP, dccQ, dccG, arlag, const)
% PURPOSE:
...
G = diag(parameters(index+(P*k):index+2*(P*k)-1));   % ARCH for negative residuals
...
Qinitial = Qbar - A'*Qbar*A - B'*Qbar*B - G'*Nbar_negative*G;
