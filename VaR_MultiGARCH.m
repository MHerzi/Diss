function [Output,rnd_ret2] = VaR_MultiGARCH(MeanForecast,VarianceForecast,GARCHOutput,Rt,n,daten,PrtFig,Spec)
...
% stele sicher dass einsen auf der Hauptdiagonalen liegen
for i=1:size(Rt,3)
    Rt_temp = Rt(:,:,i) - diag(diag(Rt(:,:,i)));
    Rt(:,:,i) = eye(k) + Rt_temp;
end
