...
dynamicType = config.model.dynamic;
archOrder = config.model.dccP;
garchOrder = config.model.dccQ;
...
[filteredLikelihood, isValid] = dccCorrelationFilter( ...
...
try
    ...
    [value, isValid] = dccCorrelationFilter(stdResiduals, [], qBar, ...
