...
%     data = 1 - data; %drehe Daten für Rotated Clayton
% end
...
if strcmp(CopulaSpec.corrspec,'Patton') == 1 && (strcmp(type,'Clayton') || strcmp(type,'Rotated Clayton') || strcmp(type,'Gumbel'))
    [LogL, Rt, likelihoods, u] = CopulaVineLL_grm(CopParams,data,CopulaSpec);
    %     make transformations
    if strcmp(CopulaSpec.optimizer,'fminunc') && (strcmp(CopulaSpec.type,'Clayton') || strcmp(CopulaSpec.type,'Rotated Clayton'))
