...
%
% INPUT:
% - tv_faktor: Parameter des GDCC Prozesses der Korrelationsmatrizen
...
function [R_tv] = copulaParam_tv_GDCC(tv_faktor, P, Q, data_inv, funktion, horizon);
...
B = diag(tv_faktor(P*s2+1:P*s2+Q*s2)); % GARCH Faktor
