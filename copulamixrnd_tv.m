...
function [sim, CopParam_pred, Weights_pred] = copulamixrnd_tv(tv_faktor,family,data,n_Sim,horizon);
...
% -----------------------------------------------------------------------
[CopParam_pred, Weights_pred] = copulamix_tv_paramforecast(tv_faktor, nc, family, data, P, Q, horizon);
