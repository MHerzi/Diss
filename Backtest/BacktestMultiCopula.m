function [Rt_pred_new,copparameters_backtest,rnd_ret2,Output] = BacktestMultiCopula(U,stdresid,GARCHOutput,GARCHOutput_Backtest,MeanForecast,VarianceForecast,PrtFig,daten,Spec)
