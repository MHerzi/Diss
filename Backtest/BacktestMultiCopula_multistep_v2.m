function [Rt_pred_new,copparameters_backtest,Output] = BacktestMultiCopula_multistep_v2(U,stdresid,GARCHOutput,GARCHOutput_Backtest,MeanForecast,VarianceForecast,PrtFig,daten,Spec,upareto)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% Unterschied zur Originalversion: die simulierten Returns werden NICHT
%%%% gespeichert, 04/04/2013
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Backtest for multivariate Copula models. Computes multivariate Copula
% models (backtest) and several  VaR estimates; multistep Erweiterung: die
% Copula-Modelle können zu verschiedenen Zeitpunkten gescätzt werden
% (Variable: Spec.ForecastNumb=forecastP
% VaR-Ergebnisse erscheinen tritzdem zusammen
%
% USAGE:
...
forecastP=Spec.ForecastNumb; %einzelne Vorhersageperioden für die multiuvariaten Copula-Modelle
...
for i=start:forecastP:t-forecastP
    ...
    for jj=1:forecastP
        ...
        countret = countret+1; %schreibe die returns und den VaR einfach immer weiter fort
        clear Sim
        clear rnd_ret
    end
    count=count+1;
...
% Christoffersen "Backtesting", S.5
