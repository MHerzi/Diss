...
function [c ceq] = nonLinCon_Skalar_mix_tv_grm(tv_faktor, CopParam_1, weights_1, family, data, P, Q, Dynamic);
...
if strcmp(Dynamic,'ADCC')
    ...
    x_1 = max(x_11);
    c_cap = (a + b + x_1*g) - epsilon; % a,b,g sind beschränkt auf positive Werte und 
    %     (a + b + x_1*g) < 1
    if ~isreal(c_cap)
