...
function [LL_Mix, LL, CopParam_tv, weights_tv, density, likelihoods_mix, likelihoods] = copulaLL_mix_tv(tv_faktor, CopParam_1, weights_1, family, data, P, Q, Dynamic);
...
% -----------------------------------------------------------------------
        case 'clayton'
            ...
            tau = copulaParam_tv_Patton(family{n_Cop},tv_faktor(nf+1:nf+3),CopParam_1(n_Cop),data,'kalibrieren'); 
...
%             archCop_Param=tau; (alternative logistische Transf.)
            for i = 1:s1
